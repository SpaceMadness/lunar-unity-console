...
class LULogMessageText: XCTestCase {
    ...
    func testBoldTags1() throws {
        let tags = [LURichTextTag(flags: LURichTextTagFlagBold, attribute: nil, range: NSMakeRange(5, 2))];
    ...
    func testBoldTags2() throws {
        let tags = [LURichTextTag(flags: LURichTextTagFlagBold, attribute: nil, range: NSMakeRange(0, 7))];
        let expected = LULogMessage(text: "This is text.", tags: tags);
    ...
    func testBoldTags3() throws {
        let tags = [LURichTextTag(flags: LURichTextTagFlagBold, attribute: nil, range: NSMakeRange(8, 5))];
        let expected = LULogMessage(text: "This is text.", tags: tags);
    ...
    func testItalicTags1() throws {
        let tags = [LURichTextTag(flags: LURichTextTagFlagItalic, attribute: nil, range: NSMakeRange(5, 2))];
        let expected = LULogMessage(text: "This is text.", tags: tags);
    ...
    func testItalicTags2() throws {
        let tags = [LURichTextTag(flags: LURichTextTagFlagItalic, attribute: nil, range: NSMakeRange(0, 7))];
        let expected = LULogMessage(text: "This is text.", tags: tags);
    ...
    func testItalicTags3() throws {
        let tags = [LURichTextTag(flags: LURichTextTagFlagItalic, attribute: nil, range: NSMakeRange(8, 5))];
        let expected = LULogMessage(text: "This is text.", tags: tags);
    ...
    func testColorTags1() throws {
        let tags = [LURichTextTag(flags: LURichTextTagFlagColor, attribute: "red", range: NSMakeRange(5, 2))];
        let expected = LULogMessage(text: "This is text.", tags: tags);
    ...
    func testColorTags2() throws {
        let tags = [LURichTextTag(flags: LURichTextTagFlagColor, attribute: "red", range: NSMakeRange(0, 7))];
        let expected = LULogMessage(text: "This is text.", tags: tags);
    ...
    func testColorTags3() throws {
        let tags = [LURichTextTag(flags: LURichTextTagFlagColor, attribute: "red", range: NSMakeRange(8, 5))];
        let expected = LULogMessage(text: "This is text.", tags: tags);
    ...
    func testMultipleTags1() throws {
        let tags = [
            LURichTextTag(flags: LURichTextTagFlagBold, attribute: nil, range: NSMakeRange(5, 2)),
            LURichTextTag(flags: LURichTextTagFlagColor, attribute: "red", range: NSMakeRange(5, 2))
        ];
        let expected = LULogMessage(text: "This is text.", tags: tags);
