...
class UnityProject
  ...
  def initialize(dir_project, bin_unity = '/Applications/Unity5/Unity.app/Contents/MacOS/Unity') # Windows support? Nah!
  ...
  def export_unity_package(file_output, assets)
    ...
    exec_unity_method 'LunarConsoleEditorInternal.PackageExporter.ExportUnityPackage', args, "Can't export Unity package: #{file_output}"
  end
