...
public class LogScene : MonoBehaviour
{
    private static readonly string[] messages = {
        ...
        "I art     : <b>Background</b> partial concurrent mark sweep GC freed 87018(2MB) AllocSpace objects, 0(0B) LOS objects, 40% free, 4MB/7MB, paused 185us total 136.531ms",
        "I art     : <b>Background</b> partial concurrent mark sweep GC freed 49471(3MB) AllocSpace objects, 0(0B) LOS objects, 33% free, 30MB/45MB, paused 1.554ms total 113.167ms",
        "I art     : <b>Background</b> partial concurrent mark sweep GC freed 1152(46KB) AllocSpace objects, 0(0B) LOS objects, 33% free, 30MB/45MB, paused 1.057ms total 107.601ms",
        ...
        "I DeviceScanner: [MDNS] Filter <i>criteria</i>: %urn:x-cast:com.google.cast.media",
        "I DeviceScanner: [MDNS] updateScannerState: No filter <i>criteria</i> was added.",
        "I DeviceScanner: [MDNS] updateScannerState: <i>criteria</i>Removed: CC32E19983 W MdnsClient_Cast: Multicast lock held. Releasing. Subtypes:\"%9E5E7C8F47989526C9BCD95D24084F6F0B27C5ED,CC32E753\"",
        "V MediaRouter: <color=#ff0000>Dispatching</color> route change: UserRouteInfo{ name=null, description=null, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
        "V MediaRouter: <color=#00ff00>Dispatching</color> route change: UserRouteInfo{ name=Nearby device, description=null, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
        "V MediaRouter: <color=#0000ff>Dispatching</color> route change: UserRouteInfo{ name=Nearby device, description=Google Cast, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
        ...
        "V MediaRouter: <color=red>Dispatching</color> route change: UserRouteInfo{ name=Alex's Chromecast, description=Chromecast, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
        ...
        "I DeviceScanner: [CastNearby] Filter <i>criteria</i>: %urn:x-cast:com.google.cast.media",
        "I DeviceScanner: [CastNearby] updateScannerState: No filter <i>criteria</i> was added.",
        "I DeviceScanner: [CastNearby] updateScannerState: <i>criteria</i>Removed: CC32E30195 V MediaRouter: <color=red>Dispatching</color> route change: UserRouteInfo{ name=Nearby device, description=Google Cast, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
        ...
        "D AudioTrack: Client defaulted notificationFrames to 14700 for frameCount 30195 V MediaRouter: <color=red>Dispatching</color> route change: UserRouteInfo{ name=null, description=null, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
        "V MediaRouter: <color=red>Dispatching</color> route change: UserRouteInfo{ name=Alex's Chromecast, description=null, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
        "V MediaRouter: <color=red>Dispatching</color> route change: UserRouteInfo{ name=Alex's Chromecast, description=Chromecast, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
