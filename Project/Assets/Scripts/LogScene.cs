...
public class LogScene : MonoBehaviour
{
    private static readonly string[] messages = {
        ...
        "V MediaRouter: <color=red>Dispatching</color> route change: UserRouteInfo{ name=null, description=null, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
        "V MediaRouter: <color=red>Dispatching</color> route change: UserRouteInfo{ name=Nearby device, description=null, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
        "V MediaRouter: <color=red>Dispatching</color> route change: UserRouteInfo{ name=Nearby device, description=Google Cast, status=null, category=RouteCategory{ name=Devices types=ROUTE_TYPE_USER  groupable=false }, supportedTypes=ROUTE_TYPE_USER , presentationDisplay=null }",
